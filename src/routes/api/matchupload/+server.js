...
export async function POST({ request }) {
    try {
        const { username, matchKey, teamKey, autoLeave, autoL1Success, autoL1Failure, autoL2Success, autoL2Failure, autoL3Success, autoL3Failure, autoL4Success, autoL4Failure, teleL1Success, teleL1Failure, teleL2Success, teleL2Failure, teleL3Success, teleL3Failure, teleL4Success, teleL4Failure, autoAlgaeDescoreSuccess, autoAlgaeDescoreFailure, autoAlgaeNetSuccess, autoAlgaeNetFailure, autoAlgaeProcessorSuccess, autoAlgaeProcessorFailure, teleAlgaeDescoreSuccess, teleAlgaeDescoreFailure, teleAlgaeNetSuccess, teleAlgaeNetFailure, teleAlgaeProcessorSuccess, teleAlgaeProcessorFailure, defense, broke, notes, deepSuccess, deepFailure, shallowSuccess, shallowFailure, parkSuccess, parkFailure, incap } = await request.json();
